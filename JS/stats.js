...
async function loadStatistics() {
  ...
  document.getElementById("stat-completed").textContent = `${stats.completedSessions} / ${stats.totalSessions}`;

  document.getElementById("stat-rate").textContent = stats.completionRate + "%";

  document.getElementById("stat-deadlines").textContent = `${completedDeadlines} / ${deadlines.length}`;
...
function renderHoursPerCourse(sessions) {
  ...
  window._chartHoursPerCourse = new Chart(document.getElementById("chartHoursPerCourse"), {
    type: "bar",
    data: {
      labels,
      datasets: [
...
function renderDeadlineStatus(deadlines) {
  ...
  window._chartDeadlineStatus = new Chart(document.getElementById("chartDeadlineStatus"), {
    type: "doughnut",
    data: {
...
function renderWeeklyCompletion(sessions) {
  ...
  window._chartWeeklyCompletion = new Chart(document.getElementById("chartWeeklyCompletion"), {
    type: "bar",
    data: {
      labels: DAY_LABELS,
      datasets: [
...
function renderHoursByDay(sessions) {
  ...
  window._chartHoursByDay = new Chart(document.getElementById("chartHoursByDay"), {
    type: "bar",
    data: {
      labels: DAY_LABELS,
      datasets: [
